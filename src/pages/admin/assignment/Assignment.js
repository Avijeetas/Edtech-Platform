...
import { useDeleteAssignmentsMutation } from "../../../features/assignments/assignmentsApi";
...
export default function Assignment({assignment}){
    ...
    return (
        <tr>
            ...
            <td class="table-td">{video_title}</td>
            <td class="table-td">{totalMark}</td>
            <td class="table-td flex gap-x-2">
                ...
                <Link to={`/admin/assignments/edit/${id}`} >
                    <svg fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor"
            ...
            {isError && <Error message={'An occur occured'}/> }
        </tr>
    )
}