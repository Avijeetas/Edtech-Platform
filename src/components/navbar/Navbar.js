    ...
    return (
        <nav class="shadow-md">
            <div class="max-w-7xl px-5 lg:px-0 mx-auto flex justify-between py-3">
                <img class="h-10" src={learningImage} />
                ...
                }
                {
                    ...
                    <button onClick={handleLogout}
                       class={`flex gap-2 border border-cyan items-center px-4 py-1 rounded-full text-sm transition-all hover:bg-cyan ${role == 'admin' ? 'bg-red-600' : ''}`}>
